(function(window, document) {
  ...
  window[pluginName].defaults = {
    ...
    density: 8500, // How many particles will be generated: one particle every n pixels
    dotColor: "#666666",
    lineColor: "#666666",
    ...
    parallax: true,
    parallaxMultiplier: 2.5, // The lower the number, the more extreme the parallax effect
    onInit: function() {},
    onDestroy: function() {}
  };
